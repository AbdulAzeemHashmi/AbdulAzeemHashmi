...
<p align="center">
  <b>🌌 Building intelligent, scalable, and beautifully designed software across Autonomous AI, Full Stack Engineering, and Cloud Architectures 🌌</b>
</p>
...
Designing autonomous digital agents, multi tool AI workstations, and natural language mission planners powered by Gemini, OpenAI, and LangChain. Focused on reliable, tool using agent workflows.

</td>
<td width="33%" valign="top">

### ⚡ Full Stack Web & API Engineering
Building performant, responsive web applications and backend microservices using Next.js, FastAPI, Flask, and Tailwind CSS. Comfortable across the entire stack, from UI to database.

</td>
<td width="33%" valign="top">

### ⚙️ Database & Cloud Architecture
Designing robust relational and document database schemas with seamless persistence and real time logging. Experienced with Supabase, SQLite, MySQL, and MongoDB in production style setups.
...
**BS Artificial Intelligence** · FAST NUCES, Islamabad Campus · *2024 → Present*
...
<sub>Designed and built with 💜 by <b>Abdul Azeem Hashmi</b></sub>
